...
<head><title>NIT Arunachal Pradesh, Govt. of India
</title>
<style type="text/css">
body {
    font-family: Arial;
...
.wrapper1 {
    ...
    height: 80px;
    background : #464646;
    background : -webkit-gradient(linear, left top, left bottom, from(rgb(168,168,168)), to(rgb(234,231,231)));
    background : -moz-linear-gradient(top, rgb(168,168,168), rgb(234,231,231));
    border-top: 2px solid #939393;
    position: relative;
...
<div class="wrapper1">
        <div class="container">
            ...
            <h3>National Institute of Technology Arunachal Pradesh <br>
(An Institute of National Importance, by an act of the Parliament)
Estd. 2010 <br>
Yupia, District Papum Pare, Arunachal Pradesh, INDIA - 791112</h2>
